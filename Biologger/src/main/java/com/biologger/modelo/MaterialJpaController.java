...
public class MaterialJpaController implements Serializable {
    ...
    public void create(Material material) {
        ...
        try {
            ...
            Usuario idusuario = material.getIdusuario();
            if (idusuario != null) {
            ...
            em.persist(material);
            if (idusuario != null) {
                idusuario.getMaterialList().add(material);
    ...
    public void edit(Material material) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Usuario idusuarioOld = persistentMaterial.getIdusuario();
            Usuario idusuarioNew = material.getIdusuario();
            if (idusuarioNew != null) {
                idusuarioNew = em.getReference(idusuarioNew.getClass(), idusuarioNew.getIdusuario());
                material.setIdusuario(idusuarioNew);
            }
            material = em.merge(material);
            if (idusuarioOld != null && !idusuarioOld.equals(idusuarioNew)) {
                idusuarioOld.getMaterialList().remove(material);
                idusuarioOld = em.merge(idusuarioOld);
            }
            if (idusuarioNew != null && !idusuarioNew.equals(idusuarioOld)) {
                idusuarioNew.getMaterialList().add(material);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Usuario idusuario = material.getIdusuario();
            if (idusuario != null) {
                idusuario.getMaterialList().remove(material);
                idusuario = em.merge(idusuario);
            }
            em.remove(material);
            em.getTransaction().commit();
